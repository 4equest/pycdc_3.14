...
BEGIN_MAP(3, 14)
    ...
    /* 2 = BUILD_TEMPLATE (new in 3.14, no canonical) */
    /* 3 = BINARY_OP_INPLACE_ADD_UNICODE (specialized) */
    ...
    MAP_OP(27, NOP)
    MAP_OP(28, NOP)                         /* NOT_TAKEN: branch hint, treat as no-op */
    MAP_OP(29, POP_EXCEPT)
    MAP_OP(30, POP_TOP)                     /* POP_ITER: pops iterator, semantically POP_TOP */
    MAP_OP(31, POP_TOP)
    ...
    /* 45 = BUILD_INTERPOLATION (new in 3.14, no canonical) */
    ...
    MAP_OP(86, LOAD_FAST_A)                 /* LOAD_FAST_BORROW: semantically LOAD_FAST */
    MAP_OP(87, LOAD_FAST_LOAD_FAST_A)       /* LOAD_FAST_BORROW_LOAD_FAST_BORROW */
    ...
    /* 235 = INSTRUMENTED_POP_ITER (no canonical) */
    ...
    /* 240 = INSTRUMENTED_NOT_TAKEN (no canonical) */
    ...
    /* 248 = INSTRUMENTED_END_ASYNC_FOR (no canonical) */
